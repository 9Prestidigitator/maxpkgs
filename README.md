...
| ------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- | ------------ | ---------------------------------------------------------------- |
| `amplocker`                                                                    | 1.5.5                                                                                           | x86_64-linux | Standalone, LV2, VST3                                            |
| `audiogridder`                                                                 | 1.2.0                                                                                           | Linux        | AudioGridder server and VST3 plug-in                             |
...
| `bitwig6`                                                                      | 6.1-beta7                                                                                       | x86_64-linux | Bitwig Studio                                                    |
| `chow-tape-model`                                                              | 2.11.4                                                                                          | Linux        | Standalone, CLAP, LV2, VST3                                      |
...
| `libonnxruntime-neuralnote`                                                    | 1ac0228d5d07890c0a504fbdeb6588e00afe1b8a                                                        | Linux        | NeuralNote support library                                       |
| `melissa`                                                                      | 4.5.0                                                                                           | x86_64-linux | Standalone practice player with stem separation                  |
| `minimeters`, `minimeters-demo`                                                | 1.0.30                                                                                          | Linux        | Demo standalone, CLAP, VST3                                      |
| `minimeters-full`                                                              | 1.0.30                                                                                          | Linux        | Paid standalone, CLAP, VST3; see [Paid Packages](#paid-packages) |
...
| `neuralnote`                                                                   | 1.1.0                                                                                           | Linux        | Standalone, VST3                                                 |
| `overwitch`                                                                    | 2.2                                                                                             | Linux        | JACK client and helpers; includes `nixosModules.overwitch`       |
| `pianoteq`, `pianoteq-trial`                                                   | 9.2.1                                                                                           | Linux        | Standard trial: standalone, LV2, VST3                            |
| `pianoteq-standard`, `pianoteq-stage`                                          | 9.2.1                                                                                           | Linux        | Paid standalone, LV2, VST3; see [Paid Packages](#paid-packages)  |
...
| `ultimate-vocal-remover-gui`                                                   | 5.6.0                                                                                           | Linux        | Standalone source-separation GUI                                 |
