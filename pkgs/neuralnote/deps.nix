{fetchurl}: [
  {
    ...
    file = fetchurl {
      url = "https://github.com/abseil/abseil-cpp/archive/refs/tags/20220623.1.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/HowardHinnant/date/archive/refs/tags/v2.4.1.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/google/flatbuffers/archive/refs/tags/v1.12.0.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/microsoft/wil/archive/5f4caba4e7a9017816e47becdd918fcc872039ba.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/microsoft/mimalloc/archive/refs/tags/v2.0.3.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/boostorg/mp11/archive/refs/tags/boost-1.79.0.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/onnx/onnx-tensorrt/archive/369d6676423c2a6dbf4a5665c4b5010240d99d3c.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/protocolbuffers/protobuf/archive/refs/tags/v3.20.2.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/dcleblanc/SafeInt/archive/ff15c6ada150a5018c5ef2172401cb4529eac9c0.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/openssl/openssl/archive/refs/tags/openssl-3.0.7.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/boostorg/boost/archive/refs/tags/boost-1.81.0.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://sourceforge.net/projects/pthreads4w/files/pthreads4w-code-v3.0.0.zip";
  ...
  }
  {
    ...
    file = fetchurl {
      url = "https://github.com/triton-inference-server/server/archive/refs/tags/v2.28.0.zip";
